...
ovat vuorovaikutteinen luokkahuone ja tarkkailija-kommunikoija-rakentaja.
...
iteratiiviseen ryhmätyöhön, jossa projektia kehitetään eteenpäin
lyhyissä sykleissä. Menetelmä pohjautuu yksilön osallistumisen tasoon, joka kuvaa yksilön sitoutumista ja työskentelyä ryhmässä. Osallistumisen tasoja on neljä, jotka ovat:
...
RTB:n ideana on maksimoida todennäköisyys, että ryhmästä löytyy henkilöitä, jotka edustavat osallistumisen tasoja 1 ja 4~\cite{Pieterse:2012:PPS:2157136.2157218}. Nämä osallistumistasot ovat haitaksi ryhmätyölle. Näin ryhmän jäsenet altistuvat pulmallisiin tilanteihin ja konflikteihin, joissa heidän täytyy oppia sosiaalisia taitoja selvittääkseen nämä ongelmat. Lopputuloksena ryhmästä tulee tehokkaampi ja ryhmän jäsenien ryhmätyötaidot kehittyvät.\\

On olemassa riskitekijöitä, joilla nostaa tasojen "social loafer" ja "diligent isolate" esiintymisen todennäköisyyttä. Nämä riskitekijät ovat:
...
tehtävien jako ja yhteistyön koordinointi hankaloituu. Tämä nostaa todennäköisyyttä, että ryhmässä esiintyy osallistumistasoa 4.
