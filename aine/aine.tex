...
\keywords{ryhmätyöskentely, ohjelmistotuotanto, persoonallisuus, myers---briggsin tyyppi-indikaattori, scrum, xp}
...
%Ennen ylläpitoa ohjelma on julkaistu kohderyhmän käyttöön valmiina tuotteena, joka toteuttaa vaatimukset
Ylläpidon
...
RTB on hyvä menetelmä muodostamaan positiivisen asenteen ryhmätyö\-hön. RTB:n avulla opiskelijat tunnistavat
...
Ryhmätyöhön rohkaiseminen ja ryhmätyöskentelyn harjoitteleminen onnistuu edellä esitellyillä menetelmillä. Ottaen huomioon, että useissa tietojenkäsittelytieteen opetusohjelmissa ei ryhmätyötaitoja opeteta tarpeeksi, tulisi näitä menetelmiä soveltaa opetuksessa. Eri menetelmien ja harjoituksien avulla opiskelijoille saadaan myönteinen kuva ryhmätyöskentelystä sekä valmiudet olla tehokkaita ryhmän jäseniä työelämässä.

\section{Yhteenveto}

\enlargethispage{\baselineskip}

Ryhmätyö on tärkeä osa ohjelmistokehitystä. Ohjelmistokehitystä varten tarkoitetut eri menetelmät ohjeistavat omalla tavallaan kuinka yhdessä toimimisen pitäisi tapahtua, jotta kehitystyö olisi mahdollisimman tuotteliasta. Ketterät menetelmät, kuten Scrum, uskovat esimerkiksi itseorganisoituvan tiimin tuottavan parhaimman lopputuloksen. Ryhmätyön vahvistamista varten on keksitty myös erilaisia käytänteitä, kuten pariohjelmointi, joilla varmistaa ryhmän jäsenten sisäinen kommunikointi ja yhteistyö. Tehokas ryhmätyö vaatii ohjenuoria ja sääntöjä, koska se vaatii opettelua siinä missä esimerkiksi ohjelmointitaitokin.\\

Menestyksekäs ryhmätyö riippuu lopulta ryhmän jäsenistä. Yksilön persoona vaikuttaa kuinka mieluinen ryhmän jäsen yksilö on. Luonteenpiirteet, jotka palvelevat ryhmätyöskentelyä, ovat muun muassa avoimuus, sosiaalisuus ja halu auttaa muita. Huonoihin piirteisiin kuuluu itsepäisyys, muiden väheksyntä ja kielteinen asenne yhteistyöhön.\\

Hyvät ryhmätyötaidot vaativat opettelua eikä niitä löydy valmiina ihmisiltä. Muiden ihmisten kanssa työskentely ja heidän ajatustensa huomioon ottaminen vaatii aina joustoa ja mukautumista. Tämän vuoksi on luotu erilaisia menetelmiä, joilla kehittää omia ryhmätaitojaan. Ne eivät kuitenkaan sovellu luonteiltaan kielteisille henkilöille, jotka vastustavat ryhmätyötä ja eivät osaa toimia ihmisten kanssa. Tietojenkäsittelytieteen opiskelijoiden tapauksessa puutteelliset ryhmätyötaidot johtuvat usein kokemattomuudesta, johon menetelmät tarjoavat avun.\\
