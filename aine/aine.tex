...
Tämän artikkelin tarkoituksena on tarkastella ryhmätyöskentelyä.
...
mikä on Myers-Briggsin tyyppi-indikaattori ja kuvaillaan ohjelmistokehittäjän eri piirteitä, jotka vaikuttavat sekä positiivisesti että negatiivisesti ryhmän työskentelyyn. Tämän jälkeen kerrotaan Myers-Briggsin tyyppi-indikaattoria käyttäen millä luonteenpiirteillä on positiivisimmat vaikutukset perinteisen ohjelmistotuotannon eri vaiheissa. Luvussa 4 kuvataan
menetelmiä, joilla voidaan orientoida ihmisiä ryhmätyöhön ja menetelmiä, joilla ryhmätyötaitoja voidaan kehittää paremmiksi.
...
\subsection{Ryhmätyöhön orientoituminen}

Seuraavat menetelmät ovat kevyitä tapoja painottaa opiskelijoita
ryhmätyöhön ja kommunikointiin muiden kanssa. Ne eivät kuitenkaan
painota ryhmätaitojen oppimista. Menetelmät, joita tarkastellaan
...
\subsection{Ryhmätyön harjoittelu}
