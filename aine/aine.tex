...
Älykkyydellä tarkoitetaan tässä tapauksessa sellaista ohjelmistokehittäjää, jolla on hyvä tekninen osaaminen ja hän on nopea
...
Seuraavaksi käymme nämä vaiheet läpi yksi kerrallaan
ja tarkastelemme millaiset ohjelmistokehittäjät sopivat
parhaiten mihinkin vaiheeseen. Oletamme, että kehittäjillä on
hyvä tekninen osaaminen kaikissa vaiheissa, jolloin voimme rajoittaa
tarkastelun ainoastaan siihen kuinka hyvin he persoonallisuustyypeiltään soveltuvat suorittamaan tiettyjä
kehityksen vaiheita.
...
muiden ihmisten seurasta. Introvertit sen sijaan ovat sisäänpäinkääntyneitä, hiljaisia, varautuneita ja ovat mielummin omissa oloissaan.
...
yhteyksiä teoreettisemman ja abstraktisemmankin tiedon pohjalta.
