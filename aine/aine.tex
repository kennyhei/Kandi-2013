...
Capretzilla ja Ahmedilla on käsitys millainen kehittäjä soveltuu
parhaiten järjestelmäanalyysiin, joka on sidoksissa vaatimusmäärittelyn kanssa~\cite{Capretz:2010:MSS:1726559.1726574}.
...
käyttäjän tarpeita. Tähän tarpeeseen on tuntevat (F) ihmiset hyviä. Optimaalisinta olisi määrätä vaatimusmäärittelyyn kehittäjiä, jotka ovat sekä ekstrovertteja että tuntevia (EF).\\
