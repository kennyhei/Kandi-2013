...
[Tähän kohtaan asiaa sopivista persoonallisuustyypeistä toteutukseen + lisää viite]
...
moitteettomasti. Testauksella pyritään myös löytämään ohjelmasta virheitä tekemällä testitilanteita, joissa yritetään
...
ja metodeita yksilöllisesti. Integraatiotestauksessa varmistetaan, että nämä komponentit, luokat ja metodit toimivat niiden ollessa keskinäisessä vuorovaikutuksessa toistensa kanssa, pyytäen ja tarjoten palveluita toisilleen. Järjestelmätestauksessa ohjelmaa testataan sen rajapinnan eli useimmiten käyttöliittymän kautta. Järjestelmätestaus liittyy vahvasti vaatimuksiin, jotka määrittävät, että järjestelmällä pitäisi pystyä tekemään jotain ja järjestelmän tulisi vastata tähän toimintoon jotenkin.\\

[Tähän kohtaan asiaa sopivista persoonallisuustyypeistä testaukseen + lisää viite]
