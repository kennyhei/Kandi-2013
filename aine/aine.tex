...
%suosivat töitä, joissa aiemmin opitun tiedon käyttö on riittävää tehtävän suorittamiseen sen sijaan, että tulisi keksiä uusia ratkaisuja. He
...
% Kuitenkin ohjelmistokehittäjille tehtyjen haastattelujen (kts.) perusteella tällaisia ihmisiä löytyy ohjelmistoalalta.\\
