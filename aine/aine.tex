...
persoonallisuustyyppejä on siis $2^4$ = 16 erilaista.
...
Capretzilla ja Ahmedilla on selkeä käsitys millainen kehittäjä soveltuu
parhaiten vaatimusmäärittelyyn~\cite{Capretz:2010:MSS:1726559.1726574}.
Vaatimusmäärittelyyn tarvitaan kehittäjiä, jotka ymmärtävät asiakkaan tarpeet ja käsittävät mitkä ovat ohjelman keskeisimmät toiminnot.
Vaatimusmäärittely vaatii paljon kommunikointia asiakkaan kanssa,
...
käyttäjän tarpeita. Tähän tarpeeseen on tuntevat (F) ihmiset hyviä. Optimaalisinta olisi siis määrätä vaatimusmäärittelyyn kehittäjiä, jotka ovat sekä ekstrovertteja että tuntevia (EF).\\
...
Toteutus on siis ohjelmointia. Ohjelmoijan tulee tunnistaa ohjelman
...
Testausvaiheessa on tarkoituksena tehdä testejä, joilla varmistetaan ohjelman toimivuus. Vaatimukset ovat ensisijaisia
...
Testaukseen on monenlaisia strategioita, jotka noudattavat järjestelmällisiä lähestymistapoja. Testaus vaatii paneutumista yksityiskohtiin, jotta testaaja varmasti tarkistaa, että pienimmätkin ohjelman osat toimivat oikein. Tarkkuus ja järjestelmällisyys ovat
haluttavia ominaisuuksia testaajalle, joita tosiasialliset (S) ja järjestelmälliset (J) henkilöt edustavat. Menestyvät testaajat olisivat siis sekä tosiasiallisia että järjestelmällisiä (SJ)~\cite{Capretz:2010:MSS:1726559.1726574}.

\subsubsection{Ylläpito}

Ennen ylläpitoa ohjelma on jo julkaistu kohderyhmän käyttöön valmiina tuotteena. Ylläpidon
